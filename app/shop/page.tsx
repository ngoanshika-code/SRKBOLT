  ...
  return (
    <div className="min-h-screen bg-[#fff5d6]">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8">
        <div className="absolute inset-0 bg-linear-to-r from-maroon-900/10 to-amber-900/10"></div>
        <div className="relative max-w-7xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-4 sm:mb-6 bg-linear-to-r from-primary via-accent to-amber-300 bg-clip-text text-transparent">
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 flex flex-col gap-2">
                    {product.bestseller && (
                      <Badge className="bg-linear-to-r from-amber-500 to-yellow-500 text-black font-semibold">
                    ...
                    {product.premium && (
                      <Badge className="bg-linear-to-r from-yellow-400 to-amber-500 text-white font-bold">
                ...
                <CardContent className="p-4 sm:p-6">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                    ...
                    <Button 
                      onClick={() => handleAddToCart(product)}
                      className="bg-linear-to-r from-maroon-700 to-maroon-600 hover:from-maroon-800 hover:to-maroon-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto text-sm sm:text-base"
                    >
      ...
      {/* Features Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-r from-maroon-50 to-amber-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {[
              {
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-r from-primary to-primary/90">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button
            size="lg"
            className="bg-linear-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-black font-semibold text-lg px-8 py-4 shadow-xl hover:shadow-2xl transition-all duration-300"
          >
            Contact Our Experts
          </Button>
        </div>
