...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fff5d6]">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-12 bg-linear-to-br from-primary via-primary/90 to-accent">
              ...
              <Card className="bg-[#f7f1be] border-0 shadow-xl">
                <CardContent className="p-12 text-center">
                  ...
                  <Link href="/collections">
                    <Button className="bg-linear-to-r from-accent to-amber-500 hover:from-accent/90 hover:to-amber-500/90 text-white">
          ...
          <div className="lg:col-span-1">
            <Card className="bg-[#f7f1be] border-0 shadow-xl sticky top-24">
              ...
              <CardContent className="space-y-4">
                ...
                <Link href="/checkout">
                  <Button 
                    className="w-full bg-linear-to-r from-accent to-amber-500 hover:from-accent/90 hover:to-amber-500/90 text-white font-bold py-4 text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
