  ...
  const jobOpenings = [
    {
      ...
      location: "Mumbai",
      experience: "5+ years",
      description: "Lead our sales team and drive business growth in the fastener industry.",
      icon: Briefcase,
    ...
    },
    {
      ...
      location: "Pune",
      experience: "3+ years",
      description: "Ensure product quality and compliance with international standards.",
      icon: CheckCircle,
    ...
    },
    {
      ...
      location: "Delhi",
      experience: "2+ years",
      description: "Provide technical support to customers and assist with product selection.",
      icon: Users,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-200 mb-6">
              Join India's leading fastener solutions provider and grow your career with us. We're looking for talented individuals to join our dynamic team.
            </p>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {jobOpenings.map((job, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`h-1 bg-linear-to-r ${job.color}`}></div>
                      <div className="p-8">
                        <div className="flex items-start justify-between mb-4">
                          <div className={`p-3 rounded-lg bg-linear-to-br ${job.color} text-white`}>
