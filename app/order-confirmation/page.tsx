...
export default function OrderConfirmationPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fff5d6]">
      ...
      <section className="pt-24 pb-12 bg-linear-to-br from-green-600 via-green-500 to-emerald-500">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {/* Customer Support */}
            <Card className="bg-linear-to-r from-primary/10 to-accent/10 border-0 shadow-xl">
            ...
            {/* Review Request */}
            <Card className="bg-linear-to-r from-amber-50 to-orange-50 border border-amber-200">
